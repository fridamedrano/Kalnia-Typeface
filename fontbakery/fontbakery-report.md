...
<details><summary><b>[10] Kalnia-Bold.ttf</b></summary><div><details><summary>💔 <b>ERROR:</b> Checking OS/2 achVendID. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/vendor_id">com.google.fonts/check/vendor_id</a>)</summary><div>
 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: malayalam, coptic, tai-le, syriac, math, old-permic, canadian-aboriginal, tifinagh
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: myanmar, buhid, nko, syriac, marchen, cham, devanagari, math, newa, psalter-pahlavi, siddham, malayalam, gunjala-gondi, hanifi-rohingya, bassa-vah, gurmukhi, khudawadi, tai-le, manichaean, chakma, kannada, hanunoo, batak, sogdian, rejang, tifinagh, zanabazar-square, miao, sundanese, masaram-gondi, coptic, tibetan, sinhala, telugu, caucasian-albanian, osage, tagalog, bhaiksuki, symbols, dogra, buginese, adlam, khojki, mahajani, yi, meetei-mayek, kaithi, wancho, thaana, brahmi, balinese, tirhuta, ahom, limbu, syloti-nagri, lao, tamil, soyombo, mandaic, mongolian, bengali, duployan, gujarati, music, phags-pa, kharoshthi, pahawh-hmong, tai-viet, hebrew, tagbanwa, kayah-li, old-permic, grantha, oriya, takri, modi, elbasan, new-tai-lue, mende-kikakui, thai, lepcha, javanese, khmer, sharada
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* j (U+006A): X=105.0,Y=707.0 (should be at cap-height 708?)

	* j (U+006A): X=250.0,Y=707.0 (should be at cap-height 708?)
	...
	* ij (U+0133): X=417.0,Y=707.0 (should be at cap-height 708?)

	* ij (U+0133): X=562.0,Y=707.0 (should be at cap-height 708?)
	...
	* fi (U+FB01): X=473.0,Y=710.0 (should be at cap-height 708?) [code: found-misalignments]
