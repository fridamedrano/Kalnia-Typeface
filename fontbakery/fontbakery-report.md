...
* 🔥 **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the "name" table: Expected "Kalnia Extended" but got "Kalnia Extended Extended Regular". [code: mismatch]
...
* 🔥 **FAIL** On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Kalnia Extended Extended Regular') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Kalnia Extended Bold') [code: does-not]
...
* ⚠ **WARN** The combined length of family and style exceeds 27 chars in the following 'WINDOWS' entries:
 FONT_FAMILY_NAME = 'Kalnia Extended Extended Regular' / SUBFAMILY_NAME = 'Bold'
